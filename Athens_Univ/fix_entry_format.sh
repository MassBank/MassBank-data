...
sed -i 's/Acetonitrile:Water 95:5 with 0.01 formic acid and 1mM ammonium formate/Acetonitrile:Water 95:5 with 0.01% formic acid and 1mM ammonium formate/' *.txt
